...
db.define_table('salle',Field('nom','string'),Field('capacite','integer'),Field('disponible','integer',default=1, readable=False, writable=False),Field('categorie_id',db.categorie,label='Type de salle', requires=IS_IN_DB(db,db.categorie.id,'%(nom)s')))
